...
Atkreipkite dėmesį, kad šiame pavyzdyje visi galimi akmenukų kiekiai
...
\end{sprendimas}
%TODO gal atkreiptį dėmesį į centrinės monetos svarbą? Be jos imituojantis
%žaidėjas nevisuomet galėtų padaryti simetrišką ėjimą.
...
%TODO negerai skiltį pradėti nuo apibrėžimų
...
%TODO ką daryti su tais atskirais atvejais? Skaitytojui pačiam išsispręsti
%prieš skaitant toliau?
...
\begin{enumerate}
  \item Žaidimo erdvė yra dvi krūvelės, kuriose atitinkamai yra po $21$ ir
    ...
    %TODO čia nėra NIM atskiras atvejis (naivia prasme)
...
%TODO kas čia vyksta? Spręsime bendrą NIM atvejį? Reiktų daug švariau ir
%aiškiau surašyti.
...
\end{enumerate}
%TODO reiktų gal bent vieno pavyzdžio, pilnai išspręsto su tuo sumavimu?


\subsubsection{NIM vertė}
%TODO blogai nuo apibrėžimo pradėti
...
\begin{sprendimas}[Pirmas sprendimas]
...
\end{sprendimas}
%TODO ar Rugliė sutiko, kad jos sprendimas bus publikuojams?
...
%TODO kas čia įvyko? Sprendimas peraugo į pašnekesius?


%TODO čia turėtų būti teorema, o ne pavyzdys.
\begin{pavnr} 
...
\begin{enumerate}
  ...
  \item Įrodykite, kad jei turime $n$ bešalių normalių žaidimų, tai jų sumos NIM
    ...
    %pagal antrąjį uždavinį suminio žaidimo NIM vertė lygi $a\oplus b$ ir šį
  ...
  \item Yra dvi krūvelės, vienoj $n$, kitoj $m$ akmenukų. Dar yra Julius su Gyčiu.
    ...
    %elementas tenkintų nelygybę $x_{n}<a<x_{n+1}$, tačiau pagal $x_{k}$ apibrėžimą, jau yra
